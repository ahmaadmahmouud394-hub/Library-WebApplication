...
namespace Library_WebApplication.Controllers
{
    ...
    public class ClientPubblishersController : Controller
    {
        private readonly AppDbContext _context;
        private readonly PubblisherBO _pubblisherBO;
        public ClientPubblishersController(AppDbContext context, PubblisherBO pubblisherBO)
        {
            _context = context;
            _pubblisherBO = pubblisherBO;
        }
        [Route("Client/Pubblishers")]
        // GET: Pubblishers
